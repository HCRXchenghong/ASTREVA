...
export const fallbackContent: SiteContent = {
  site: {
    ...
    serviceBridgeUrl: process.env.PUBLIC_SERVICEBRIDGE_URL || '',
    defaultSeo: {
  ...
  products: [
    ...
    },
    {
      ...
      coverImage: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&q=80&w=900',
      galleryImages: [],
